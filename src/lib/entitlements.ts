...
export const FREE_LIMITS = {
  watchlist: 20,
  holdings: 10,
  leaderSubscriptions: 3,
  leagues: 1,
} as const

/** PRO 혜택 요약 — SettingsModal 비교 카드 등에서 사용. */
export const PRO_BENEFITS: { icon: string; title: string; free: string; pro: string }[] = [
  { icon: '💬', title: 'AI 비서 질문', free: '하루 10회', pro: '하루 100회 + 상위 모델' },
  { icon: '🧠', title: 'AI 종목 심층 리포트', free: '—', pro: '하루 5회' },
  { icon: '🎯', title: '목표가 알림 (상한·하한)', free: '—', pro: '무제한' },
  { icon: '📰', title: '장중·미국장 마감 브리프', free: '—', pro: '제공' },
  { icon: '⭐', title: '관심 종목', free: `${FREE_LIMITS.watchlist}개`, pro: '무제한' },
  { icon: '💼', title: '보유 종목', free: `${FREE_LIMITS.holdings}개`, pro: '무제한' },
  { icon: '📣', title: '리더 구독', free: `${FREE_LIMITS.leaderSubscriptions}명`, pro: '무제한' },
  { icon: '🏆', title: '리그 생성', free: `${FREE_LIMITS.leagues}개`, pro: '무제한' },
]
